...
--- [_Original project date: 09/05/2019_] ---

The 8-Bit Computer:\
<a href="https://github.com/matanbright/Electronics-8BitComputer/blob/main/images/Breadboard%208%20Bit%20Computer%20image.jpg?raw=true">
  <img src="https://github.com/matanbright/Electronics-8BitComputer/blob/main/images/Breadboard%208%20Bit%20Computer%20image%20(thumbnail).png?raw=true" alt="The 8-Bit Computer" />
</a>

Programming the Computer:\
<img src="https://github.com/matanbright/Electronics-8BitComputer/blob/main/images/Programming%20the%20Computer.gif?raw=true" alt="Programming the Computer" />

Running a Program:\
<img src="https://github.com/matanbright/Electronics-8BitComputer/blob/main/images/Running%20a%20Program.gif?raw=true" alt="Running a Program" />

## Introduction

This is a simple programmable 8-bit computer that is built from scratch on a breadboard.
...
| SRout*      | Connects the ALU's output lines to the bus                                                 |
| SRsubtract  | Causes the ALU to output a subtraction result instead of an addition result                |
...
_\* Warning: Only one signal from these can be outputted at a time because there can be only one component that outputs its data to the bus at a time. If multiple components are outputting their data to the bus at the same time, a short-circuit may occur which may cause the computer to restart, and in the worst case, it may even damage the components._
...
<b>Parameter:</b> x
<b>Description:</b> Writes the value from RAM at address 'x' to the "A" register.
...
<b>Parameter:</b> x
<b>Description:</b> Writes the value from the "A" register to RAM at address 'x'.
...
<b>Parameter:</b> x
<b>Description:</b> Adds the value from RAM at address 'x' to the "A" register.
...
<b>Micro-codes</b>:
  ...
  5) SRout, RAin                  :    Transfers the value of the addition result from the ALU into
                                       register A.
...
<b>Parameter:</b> x
<b>Description:</b> Substracts the value from RAM at address 'x' from the "A" register.
...
<b>Micro-codes</b>:
  ...
  4) RAMout, RBin                 :    Transfers the content from the RAM at the address stored in the
                                       memory address register into register B.
  5) SRsubtract, SRout, RAin      :    Tells the ALU to perform subtraction and transfers the value of the
...
<b>Description:</b> Shows the value from the "A" register on the Digits Display.
...
This program causes the computer to output the numbers in the Fibonacci sequence one by one (please note that it will continue forever, but the values will start to be invalid after the number 127 because the maximum size of the output register is 8 bits so an overflow will occur).
